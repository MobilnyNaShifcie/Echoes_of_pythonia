"""Capture the real blacksmith screen in an isolated profile under ignored build/."""
import argparse
...
def main():
    ...
    work = ROOT / 'build/blacksmith-workbench-review' / args.stage
    ...
    commands = [] if args.only_tests else [
        ...
        ('capture', ['--rendering-method', 'gl_compatibility', '--rendering-driver', 'opengl3',
                     ...
                     '--script', 'res://tools/capture_blacksmith_workbench.gd',
