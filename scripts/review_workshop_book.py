"""Render Mirela's real service with isolated saves; generated evidence stays in build/."""
import argparse
import os
...
def main():
    ...
    work = ROOT / 'build/workshop-book-review' / args.stage
    ...
    commands = [] if args.only_tests else [
        ...
        ('capture', ['--rendering-method', 'gl_compatibility', '--rendering-driver', 'opengl3',
                     ...
                     '--script', 'res://tools/capture_workshop_book.gd',
