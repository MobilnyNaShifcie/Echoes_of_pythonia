...
| `combat/heroes/pierrot.png` | Pierrot v2 — statyczny bohater bojowy | Owner-supplied generated artwork | `52552C68626C10B6E7BDF38F16EAD87A0D25F3A947EBD13E65F1977E52101C1E` |
...
`cursed_scarecrow` and `night_guard` intentionally remain named placeholders.
Their supplied source PNG files are opaque RGB images without an alpha channel,
so integrating them would display a black rectangle over the battlefield. A
transparent-background export is required before they pass the production gate.
