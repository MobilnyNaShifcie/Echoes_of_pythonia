...
const CityEconomyConfigClass := preload("res://ui/screens/city_economy/city_economy_config.gd")
const SERVICE_PRESENTATION := CityEconomyConfigClass.SERVICE_PRESENTATION
const MODES := CityEconomyConfigClass.MODES
