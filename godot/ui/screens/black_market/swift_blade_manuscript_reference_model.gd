...
const SPINE_PATH := [Vector2(133,192),Vector2(118,246),Vector2(138,323),Vector2(166,431),Vector2(195,540),Vector2(226,651),Vector2(255,759),Vector2(285,869),Vector2(313,978),Vector2(307,1084),Vector2(290,1153),Vector2(318,1183)]
const SPINE_WIDTHS := [29.0,64.0,59.0,60.0,61.0,62.0,61.0,60.0,57.0,47.0,27.0,16.0]
const CORNERS := [
	[Vector2(139,149),Vector2(281,120),Vector2(257,149),Vector2(253,168),Vector2(269,180),Vector2(239,188),Vector2(224,211),Vector2(226,233),Vector2(243,246),Vector2(217,245),Vector2(202,261),Vector2(189,286)],
	[Vector2(658,43),Vector2(814,7),Vector2(828,17),Vector2(888,152),Vector2(851,117),Vector2(826,115),Vector2(809,126),Vector2(815,103),Vector2(803,84),Vector2(774,72),Vector2(745,71),Vector2(712,83),Vector2(714,68),Vector2(699,53)],
	[Vector2(348,854),Vector2(375,882),Vector2(393,889),Vector2(412,882),Vector2(406,909),Vector2(430,936),Vector2(461,944),Vector2(489,938),Vector2(493,960),Vector2(541,980),Vector2(545,995),Vector2(375,1042),Vector2(383,1018)],
	[Vector2(1096,686),Vector2(1106,690),Vector2(1174,840),Vector2(1167,855),Vector2(983,897),Vector2(976,885),Vector2(1007,862),Vector2(1018,838),Vector2(1015,822),Vector2(1005,815),Vector2(1041,815),Vector2(1069,804),Vector2(1082,782),Vector2(1080,756),Vector2(1052,735),Vector2(1085,726)]
]
const BLADES := [
	[Vector2(382,527),Vector2(480,502),Vector2(571,469),Vector2(638,425),Vector2(689,367),Vector2(721,305),Vector2(740,244),Vector2(747,279),Vector2(746,319),Vector2(735,358),Vector2(717,392),Vector2(685,428),Vector2(641,457),Vector2(581,482),Vector2(500,505)],
	[Vector2(489,602),Vector2(575,573),Vector2(655,539),Vector2(723,501),Vector2(778,458),Vector2(824,416),Vector2(806,454),Vector2(779,488),Vector2(745,519),Vector2(705,544),Vector2(652,564),Vector2(582,586)],
	[Vector2(458,686),Vector2(540,666),Vector2(607,644),Vector2(649,620),Vector2(665,601),Vector2(665,589),Vector2(651,581),Vector2(628,579),Vector2(651,573),Vector2(675,578),Vector2(689,591),Vector2(691,609),Vector2(681,631),Vector2(661,646),Vector2(624,661),Vector2(567,673)]
]
const FLOURISHES := [
	[Vector2(329,490),Vector2(521,434),Vector2(530,436),Vector2(530,444),Vector2(511,452)],
	[Vector2(476,435),Vector2(498,412),Vector2(523,401),Vector2(549,399),Vector2(568,407),Vector2(573,420),Vector2(565,439),Vector2(545,454),Vector2(555,437),Vector2(559,421),Vector2(550,411),Vector2(533,410),Vector2(513,415)],
	[Vector2(389,574),Vector2(576,528),Vector2(588,530),Vector2(584,537),Vector2(551,545)],
	[Vector2(481,535),Vector2(558,510),Vector2(601,504),Vector2(624,508),Vector2(634,519),Vector2(632,534),Vector2(615,550),Vector2(622,532),Vector2(618,519),Vector2(603,516),Vector2(574,520)],
	[Vector2(421,652),Vector2(617,599),Vector2(630,600),Vector2(627,609),Vector2(593,620)]
]
const INNER_GUARDS := [
	[Vector2(273,201),Vector2(309,211),Vector2(361,178),Vector2(339,213),Vector2(339,234),Vector2(361,246),Vector2(329,249),Vector2(308,265),Vector2(294,290),Vector2(293,250)],
	[Vector2(660,126),Vector2(704,132),Vector2(747,117),Vector2(751,146),Vector2(777,179),Vector2(747,163),Vector2(722,162),Vector2(710,171),Vector2(708,150),Vector2(690,137)],
	[Vector2(430,812),Vector2(477,837),Vector2(523,815),Vector2(519,843),Vector2(534,866),Vector2(503,861),Vector2(482,876),Vector2(463,897),Vector2(463,862)],
	[Vector2(884,729),Vector2(928,734),Vector2(956,713),Vector2(967,689),Vector2(971,740),Vector2(987,773),Vector2(965,770),Vector2(944,779),Vector2(914,801),Vector2(919,771),Vector2(910,749)]
]
...
func build(view) -> void:
	...
	_solid([Vector2(910,414),Vector2(1012,398),Vector2(1034,402),Vector2(1049,431),Vector2(1067,472),Vector2(1066,499),Vector2(1041,510),Vector2(1020,487),Vector2(942,505)], "LeatherClasp", leather, 19, 30)
	_solid([Vector2(891,416),Vector2(972,402),Vector2(980,411),Vector2(915,426),Vector2(904,445),Vector2(911,469),Vector2(936,493),Vector2(1006,482),Vector2(1011,494),Vector2(930,514),Vector2(899,485),Vector2(864,473),Vector2(879,451)], "SilverBuckle", silver, 33, 15)
	_solid([Vector2(931,429),Vector2(946,441),Vector2(972,451),Vector2(952,467),Vector2(947,483),Vector2(931,470),Vector2(907,462),Vector2(923,448)], "ClaspDiamond", silver, 43, 13)
	for entry in [[Vector2(192,169),16.0],[Vector2(800,42),15.0],[Vector2(418,978),17.0],[Vector2(1118,815),17.0],[Vector2(943,452),10.0]]:
		_rivet(entry[0], entry[1], "DomedRivet%d" % host.model.get_child_count(), 52 if entry[0].x == 943 else 23)
	_page_edges()
...
func _depth(pixel: Vector2, ribbon := false, spine := false) -> float:
	...
	if spine:
		...
		return _depth(best_center)-70.0+sqrt(maxf(0.0,1.0-relative*relative))*(width*1.15+70.0)
...
func _uv(pixel: Vector2, toward: Vector2) -> Vector2:
	...
	for step in 24:
		...
		for offset: Vector2i in [Vector2i.ZERO,Vector2i(-2,0),Vector2i(2,0),Vector2i(0,-2),Vector2i(0,2)]:
			...
			if sample.x < 0 or sample.y < 0 or sample.x >= 1199 or sample.y >= 1312 or source_image.get_pixel(sample.x,sample.y).a < 0.98:
				opaque = false
				break
		if opaque:
			break
...
func _solid(outline: Array, node_name: String, mat: Material, lift: float, thickness: float, ribbon := false, spine := false) -> void:
	...
	for i in range(0, indices.size(), 3):
		...
		for front: bool in [true,false]:
			_solid_face(st,pixels,center,lift-(0.0 if front else thickness),front,ribbon,spine,2 if spine else 0)
	for i in polygon.size():
		var a := polygon[i]
		...
		for step in divisions:
			...
			var vertices := [point(p,_depth(p,ribbon,spine)+lift),point(q,_depth(q,ribbon,spine)+lift),point(p,_depth(p,ribbon,spine)+lift-thickness),point(q,_depth(q,ribbon,spine)+lift-thickness)]
...
func _solid_face(st: SurfaceTool, pixels: Array, center: Vector2, lift: float, front: bool, ribbon: bool, spine: bool, divisions: int) -> void:
	if divisions > 0:
		var ab: Vector2 = (pixels[0]+pixels[1])*0.5
		var bc: Vector2 = (pixels[1]+pixels[2])*0.5
		var ca: Vector2 = (pixels[2]+pixels[0])*0.5
		for triangle in [[pixels[0],ab,ca],[ab,pixels[1],bc],[ca,bc,pixels[2]],[ab,bc,ca]]:
...
func _triangle(st: SurfaceTool, vertices: Array, pixels: Array, center: Vector2, front: bool) -> void:
	...
	for row in path.size()-1:
		for slice in 4:
			for side in 32:
				var pixels: Array[Vector2] = []
				var vertices: Array[Vector3] = []
				for corner: Vector2i in [Vector2i(side,slice),Vector2i(side+1,slice),Vector2i(side,slice+1),Vector2i(side+1,slice+1)]:
					var t := corner.y/4.0
					var angle := TAU*corner.x/32.0
					var center: Vector2 = path[row].lerp(path[row+1],t)
					var tangent := _spine_tangent(path,row).lerp(_spine_tangent(path,row+1),t).normalized()
					...
					vertices.append(point(pixel,_depth(center)-70.0+sin(angle)*(width*1.15+70.0)))
				for index in [0,2,1,1,2,3]:
	...
	for endpoint in [0,path.size()-1]:
		...
		for side in 32:
			...
			for edge: int in [side,side+1]:
				...
				var pixel: Vector2 = center+Vector2(tangent.y,-tangent.x)*cos(angle)*widths[endpoint]
				pixels.append(pixel)
				vertices.append(point(pixel,_depth(center)-70.0+sin(angle)*(widths[endpoint]*1.15+70.0)))
			_triangle(st,vertices,pixels,center,endpoint==0)
	_finish(st,"RoundedLeatherSpine",leather)
	var bands := [
		[Vector2(82,331),Vector2(96,309),Vector2(129,288),Vector2(162,282),Vector2(174,293),Vector2(178,310),Vector2(153,313),Vector2(126,324),Vector2(104,345),Vector2(87,375)],
		[Vector2(128,574),Vector2(153,540),Vector2(191,518),Vector2(223,510),Vector2(240,521),Vector2(245,539),Vector2(209,545),Vector2(179,560),Vector2(151,591),Vector2(137,622)],
		[Vector2(183,829),Vector2(213,803),Vector2(252,786),Vector2(282,785),Vector2(298,798),Vector2(306,819),Vector2(268,822),Vector2(237,835),Vector2(209,861),Vector2(193,888)],
		[Vector2(230,1028),Vector2(262,993),Vector2(305,977),Vector2(330,978),Vector2(346,995),Vector2(349,1010),Vector2(310,1014),Vector2(279,1028),Vector2(252,1056),Vector2(241,1090)]
	]
	for i in bands.size():
		_solid(bands[i],"RaisedSpineBand%d" % i,leather,6,13,false,true)
	_solid([Vector2(111,407),Vector2(129,422),Vector2(153,428),Vector2(139,460),Vector2(125,514),Vector2(110,490),Vector2(103,457)],"SpineSilverStud0",silver,9,12,false,true)
	_solid([Vector2(161,652),Vector2(179,669),Vector2(206,677),Vector2(192,711),Vector2(182,764),Vector2(163,735),Vector2(156,699)],"SpineSilverStud1",silver,9,12,false,true)
...
func _rivet(center: Vector2, radius: float, node_name: String, lift: float) -> void:
	...
	for ring in 8:
		for side in 20:
			var pixels: Array[Vector2] = []
			var vertices: Array[Vector3] = []
			for corner: Vector2i in [Vector2i(side,ring),Vector2i(side+1,ring),Vector2i(side,ring+1),Vector2i(side+1,ring+1)]:
...
func _page_edges() -> void:
	...
	for i in 12:
		...
		_solid([left,right,right+Vector2(-0.3,2.0),left+Vector2(-0.3,2.0)],"ParchmentEdge%02d" % i,paper,lift+20,3)
...
func _lay_flat_on_counter() -> void:
	...
	var rest_basis := Basis(Vector3.UP,deg_to_rad(6.0)) * Basis(Quaternion(cover_normal,Vector3.UP))
	...
	var offset := Vector3(-(minimum.x+maximum.x)*0.5,0.018-back_bottom,-(minimum.z+maximum.z)*0.5)
...
func _resting_ribbon() -> void:
	_solid([Vector2(408,1083),Vector2(485,1067),Vector2(508,1140),Vector2(527,1201),Vector2(549,1242),Vector2(591,1277),Vector2(550,1271),Vector2(519,1250),Vector2(501,1267),Vector2(490,1293),Vector2(477,1274),Vector2(455,1220)],"CrimsonRibbon",leather,-132,5)
