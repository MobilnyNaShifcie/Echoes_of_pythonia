...
const EXPECTED := {
	"spider_silk": ["common", "material", "", 0],
	"venom_gland": ["uncommon", "material", "", 0],
	"spiderstep_boots": ["rare", "equipment", "feet", 3],
	"spiderweave_gloves": ["rare", "equipment", "hands", 3],
	"cultist_cloth": ["common", "material", "", 0],
	"dark_sigil": ["uncommon", "material", "", 0],
	"cultist_pendant": ["rare", "equipment", "necklace", 3],
	"dark_sigil_ring": ["rare", "equipment", "ring", 3],
	"rusted_plate": ["common", "material", "", 0],
	"rotting_knight_helm": ["rare", "equipment", "head", 4],
	"corrupted_hide": ["common", "material", "", 0],
	"black_bear_claw": ["uncommon", "material", "", 0],
	"bearhide_belt": ["rare", "equipment", "belt", 4],
	"blackwood_mail": ["rare", "equipment", "chest", 4],
	"damned_essence": ["uncommon", "material", "", 0],
	"wraith_ring": ["rare", "equipment", "ring", 4],
	"black_antler": ["uncommon", "material", "", 0],
	"black_antler_charm": ["rare", "equipment", "bracelet", 4],
	"blackwood_heart": ["rare", "material", "", 0],
	"executioner_axe": ["epic", "equipment", "weapon", 5],
	"executioner_mask": ["epic", "equipment", "head", 5],
	"blackwood_longbow": ["uncommon", "equipment", "weapon", 5],
	"blackwood_staff": ["uncommon", "equipment", "weapon", 5],
	"crooked_fate_lance": ["uncommon", "equipment", "weapon", 5],
	"bog_ichor": ["common", "material", "", 0],
	"swamp_reed": ["common", "material", "", 0],
	"mirewalker_boots": ["rare", "equipment", "feet", 5],
	"drowned_bone": ["common", "material", "", 0],
	"drowned_coin": ["uncommon", "material", "", 0],
	"drowned_gauntlets": ["rare", "equipment", "hands", 5],
}
